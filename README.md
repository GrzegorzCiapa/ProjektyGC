...
### 3. [Testowanie losowości ciągów generowanych przez QRNG]() !In Progress!
**Opis:** Kompleksowa analiza bezpieczeństwa i jakości kwantowych generatorów liczb losowych (QRNG). Projekt obejmuje wykorzystanie zaawansowanych baterii testów statystycznych do weryfikacji ciągów kwantowych oraz badanie progów wykrywalności ukrytych korelacji w ciągach częściowo deterministycznych.
